...
export function RelayV2ManualTaskForm({ projects }: { projects: ProjectOption[] }) {
  ...
  return <form className="form" onSubmit={submit}>
    ...
    <label>Reviewer<select name="reviewer" defaultValue="none"><option value="none">None</option><option value="auto">Auto</option><option value="codex">Codex</option><option value="claude">Claude</option></select></label>
